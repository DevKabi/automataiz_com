      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 lg:gap-10 pb-16 border-b border-white/[0.08]">
          ...
          <div className="col-span-1 sm:col-span-2 space-y-4">
            ...
            <p className="text-sm sm:text-base text-neutral-300 leading-relaxed pr-6">
            ...
            <div className="pt-2 space-y-2.5 text-sm text-neutral-200">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:hello@automataiz.com" className="hover:text-brand-green transition-colors font-medium">
                  hello@automataiz.com
                </a>
              </div>
              <div className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-brand-green shrink-0" />
                <a href="tel:+918338091603" className="hover:text-brand-green transition-colors font-medium">
                  +91 8338091603
                </a>
              </div>
            </div>
            ...
            <div className="pt-3">
              <div className="text-xs font-mono text-neutral-300 mb-2.5 uppercase tracking-wider font-semibold">
              ...
              <div className="flex items-center gap-2 flex-wrap">
                <a
                  ...
                  aria-label="LinkedIn"
                  className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-brand-green/20 border border-white/[0.08] hover:border-brand-green/40 text-neutral-300 hover:text-brand-green flex items-center justify-center transition-all duration-200"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-brand-gold/20 border border-white/[0.08] hover:border-brand-gold/40 text-neutral-300 hover:text-brand-gold flex items-center justify-center transition-all duration-200"
                >
                ...
                <a
                  ...
                  className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-pink-500/20 border border-white/[0.08] hover:border-pink-500/40 text-neutral-300 hover:text-pink-400 flex items-center justify-center transition-all duration-200"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="YouTube"
                  className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-red-500/20 border border-white/[0.08] hover:border-red-500/40 text-neutral-300 hover:text-red-400 flex items-center justify-center transition-all duration-200"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-9 h-9 rounded-xl bg-white/[0.04] hover:bg-blue-600/20 border border-white/[0.08] hover:border-blue-600/40 text-neutral-300 hover:text-blue-400 flex items-center justify-center transition-all duration-200"
                >
                  <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
          ...
          {/* Product Modules */}
          <div>
            <h4 className="text-sm font-mono uppercase tracking-widest text-brand-green font-bold mb-4">
              Platform
            </h4>
          ...
          {/* Solutions Pillars */}
          <div>
            <h4 className="text-sm font-mono uppercase tracking-widest text-brand-gold font-bold mb-4">
              Solutions
            </h4>
            <ul className="space-y-2.5 text-sm text-neutral-300">
              <li>
          ...
          {/* Industry Verticals */}
          <div>
            <h4 className="text-sm font-mono uppercase tracking-widest text-brand-lime font-bold mb-4">
              Industries
            </h4>
            <ul className="space-y-2.5 text-sm text-neutral-300">
              <li>
          ...
          {/* Company & Founder */}
          <div>
            <h4 className="text-sm font-mono uppercase tracking-widest text-neutral-200 font-bold mb-4">
              Company
            </h4>
            <ul className="space-y-2.5 text-sm text-neutral-300">
              <li>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs sm:text-sm text-neutral-400 text-center md:text-left">
          <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
            <span className="font-mono">© {new Date().getFullYear()} Automataiz Technologies. All rights reserved.</span>
            <span className="hidden sm:inline text-neutral-700">|</span>
            <span className="text-neutral-300">Official Tagline: &quot;The Future of Business. Automated.&quot;</span>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 sm:gap-6">
            ...
            <Link href="/ai-safety" className="hover:text-white transition-colors">
              AI Safety & Governance
            </Link>
            <span className="text-brand-green font-mono font-semibold">Bhubaneswar, India 🇮🇳</span>
          </div>
        </div>
      </div>
    </footer>
